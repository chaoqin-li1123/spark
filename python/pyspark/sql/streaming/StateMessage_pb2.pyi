...
class Get(_message.Message):
    ...
    ttl: TTLConfig
    def __init__(self, ttl: Optional[Union[TTLConfig, Mapping]] = ...) -> None: ...
...
class StateResponse(_message.Message):
    __slots__ = ["errorMessage", "statusCode"]
    ERRORMESSAGE_FIELD_NUMBER: ClassVar[int]
    STATUSCODE_FIELD_NUMBER: ClassVar[int]
    errorMessage: str
    statusCode: int
    def __init__(self, statusCode: Optional[int] = ..., errorMessage: Optional[str] = ...) -> None: ...
...
class ValueStateUpdate(_message.Message):
    ...
    schema: str
    value: bytes
    def __init__(self, schema: Optional[str] = ..., value: Optional[bytes] = ...) -> None: ...
